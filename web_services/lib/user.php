 ...
 */
/**
 * Web service to get an array of profiles
 *
 * @return  Array of profiles
 */

function user_get_arrayofusers($start) {
$ji =0;
$size = 'medium';
...
$profile_info['guid'] = $entity->guid;
$profile_info['username'] = $entity->username;
$profile_info['name'] = $entity->name;

$profile_info['avatar_url'] = $user->getIconURL($size);
$entidad[$ji] = $profile_info;
$ji = $ji + 1;
//do my processing
...
expose_function('user.get_arrayofusers',
				"user_get_arrayofusers",
				array(   'start' => array ('type' => 'integer')
						),
